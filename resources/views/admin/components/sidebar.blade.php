    ...
    <nav class="p-4 space-y-4">
        ...
        <div>
            ...
            <a href="{{ route('admin.dashboard') }}"
               class="mt-2 flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-red-600 transition {{ request()->routeIs('admin.dashboard') ? 'bg-red-700' : '' }}">
        ...
        <div>
            ...
            <a href="{{ route('admin.categorias') }}"
               class="mt-2 flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-red-600 transition {{ request()->routeIs('admin.categorias') ? 'bg-red-700' : '' }}">
