...
<body class="bg-gray-100 flex items-center justify-center py-12">
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden w-full max-w-4xl flex flex-col md:flex-row items-stretch">
        ...
        <div class="hidden md:block md:w-1/2">
            <img src="<?php echo e(asset('images/admin/login.jpg')); ?>" alt="Imagen admin" class="w-full h-full object-cover">
        </div>
...
<?php /**PATH C:\xampp\htdocs\polleria\resources\views/admin/login.blade.php ENDPATH**/ ?>