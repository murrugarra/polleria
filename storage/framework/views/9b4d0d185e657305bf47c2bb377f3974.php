<nav x-data="{ open: false }" class="bg-white shadow">
    <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
        <a href="<?php echo e(route('home')); ?>" class="text-2xl font-bold text-red-600">El Buen Sabor</a>
        ...
        <ul class="hidden md:flex space-x-6 font-medium text-lg">
            <li><a href="<?php echo e(route('menu')); ?>" class="hover:text-red-500">Menú</a></li>
    ...
    <div x-show="open" class="md:hidden px-4 pb-4">
        <ul class="space-y-2 font-medium">
            <li><a href="<?php echo e(route('menu')); ?>" class="block hover:text-red-500">Menú</a></li>
...
</nav><?php /**PATH C:\xampp\htdocs\polleria\resources\views/client/components/navbar.blade.php ENDPATH**/ ?>